...
class ProfileController extends Controller
{
    ...
    {
        $this->validate($request, ['first_name' => 'required|alpha_num|max:20', 'last_name' => 'required|alpha_num|max:20', 'gender' => 'boolean|required', 'birthdate' => 'date|required',
        ]);
        $profileExists = $this->profileExists();
        if ($profileExists) {
            return Redirect::route('show-profile');
    ...
    public function update(Request $request, $id)
    {
        ...
        $profile->update(['first_name' => $request->first_name, 'last_name' => $request->last_name, 'gender' => $request->gender, 'birthdate' => $request->birthdate]);
